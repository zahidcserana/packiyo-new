...
export const loader = async ({request}) => {
    ...
    return {
        breadcrumbs: [
            ...
            { label: 'Packing Slip Printer', to: '' }
        ],
        PackingSlipPrinterForm: await data({request})
    }
};
...
const PackingSlipPrinter = () => {
    const {breadcrumbs, PackingSlipPrinterForm} = useLoaderData<typeof loader>();

    return (
        <Page breadcrumbs={breadcrumbs}>
            <DefaultForm {...PackingSlipPrinterForm} />
        </Page>
    )
}

export default PackingSlipPrinter;
