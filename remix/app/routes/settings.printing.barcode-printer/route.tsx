...
export const loader = async ({request}) => {
    ...
    return {
        breadcrumbs: [
            ...
            { label: 'Barcode Printer', to: '' }
        ],
        BarcodePrinterForm: await data({request})
    }
};
...
const BarcodePrinter = () => {
    const {breadcrumbs, BarcodePrinterForm} = useLoaderData<typeof loader>();

    return (
        <Page breadcrumbs={breadcrumbs}>
            <DefaultForm {...BarcodePrinterForm} />
        </Page>
    )
}
