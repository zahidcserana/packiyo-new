...
export const loader = async ({request}) => {
    ...
    return {
        breadcrumbs: [
            ...
            { label: 'Pick Route Mode', to: '' }
        ],
        PickRouteModeForm: await data({request})
    }
};
...
const PickRouteMode = () => {
    const {breadcrumbs, PickRouteModeForm} = useLoaderData<typeof loader>();

    return (
        <Page breadcrumbs={breadcrumbs}>
            <DefaultForm {...PickRouteModeForm} />
        </Page>
    )
}

export default PickRouteMode;
