...
const EasypostCredentials = () => {
    const {breadcrumbs, credentialsTable, endorsements} = useLoaderData<typeof loader>();
            ...
            <Modal show={showCreateModal} onHide={() => setShowCreateModal(false)}>
                <Form onSubmit={(event) => {
                    ...
                    <Modal.Body>
                        ...
                        <TextInput name="test_api_key" type="text" title="Test API Key" required={true} />
                        <TextInput name="commercial_invoice_signature" type="text" title="Commercial invoice signature" required={true} />
                        <TextInput name="commercial_invoice_letterhead" title="Commercial invoice letterhead" required={true} />
                        <SelectInput name="endorsement" title="Endorsement" options={endorsements} required={true} />
                        <ToggleInput name="use_native_tracking_urls" title="Use native tracking URLs" required={true} />
                    </Modal.Body>
                    <Modal.Footer>
...
export default EasypostCredentials;
