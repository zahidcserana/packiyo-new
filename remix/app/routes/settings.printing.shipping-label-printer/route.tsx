...
export const loader = async ({request}) => {
    ...
    return {
        breadcrumbs: [
            ...
            { label: 'Shipping Label Printer', to: '' }
        ],
        ShippingLabelPrinterForm: await data({request})
    }
};
...
const ShippingLabelPrinter = () => {
    const {breadcrumbs, ShippingLabelPrinterForm} = useLoaderData<typeof loader>();

    return (
        <Page breadcrumbs={breadcrumbs}>
            <DefaultForm {...ShippingLabelPrinterForm} />
        </Page>
    )
}
