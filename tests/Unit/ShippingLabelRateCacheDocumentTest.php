...
class ShippingLabelRateCacheDocumentTest extends TestCase
{
    ...
    {
        $expectedProperties = ['order_id', 'customer_id', 'charges', 'shipments', 'billingRate'];
        ...
        $chargedCacheDocument = ShippingLabelRateShipmentCacheDocument::make([$charged], [], $billingRate, $customer, $order->id);
        ...
        $this->assertIsArray($chargedCacheDocument->getAttributes()['shipments']);
