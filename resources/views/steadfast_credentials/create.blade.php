            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive p-4">
                        <form method="post" action="{{ route('customers.steadfast_credentials.store', compact('customer')) }}" id="create-steadfast-credentials-form" autocomplete="off">
                            @csrf
                            <div class="pl-lg-4">
                                @if(!isset($customer))
                                ...
                                @include('shared.forms.input', [
                                    ...
                                    'value' => 'https://portal.steadfast.com.bd/api/v1',
                                    'required' => false
                                ])
                                @include('shared.forms.input', [
                                    'name' => 'api_key',
