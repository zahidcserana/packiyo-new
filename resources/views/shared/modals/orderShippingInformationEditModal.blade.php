<div class="modal fade confirm-dialog" id="order-shipping-information-edit" role="dialog">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content productForm">
            ...
            <div class="modal-body text-white pb-3 pt-0 overflow-auto">
                ...
                <button type="button"
                        data-dismiss="modal"
                        class="{{ $buttonClass ?? '' }} btn bg-logoOrange text-white mx-auto px-5 font-weight-700 confirm-button mt-5 shipping_contact_info_set"
                >
                    {{ __('OK') }}
                </button>
            </div>
