<div class="modal fade confirm-dialog" id="confirm-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header px-0 d-flex flex-column align-items-center">
                ...
                <h2 class="text-logo-orange font-lg font-weight-600 modal-title" data-default-title="{{ __('Confirmation') }}"></h2>
            </div>
            ...
            <div class="modal-footer mx-auto">
                <button
                    type="button"
                    class="btn btn-secondary modal-button-cancel"
                    data-default-cancel-button-text="{{ __('Cancel') }}"
                    data-dismiss="modal"
                ></button>
                <button
                    class="btn bg-logoOrange px-5 font-weight-700 change-tab text-white modal-button-confirm"
                    data-default-confirm-button-text="{{ __('Confirm') }}"
                    data-dismiss="modal"
                ></button>
            </div>
        </div>
