...
<form action="" method="post" style="display: inline-block" id="deleteVendorForm">
    @method('delete')
...
<div class="modal-footer">
    <button type="submit" class="btn bg-logoOrange mx-auto px-5 text-white deleteVendor">{{ __('Confirm') }}</button>
</div>
</form>
