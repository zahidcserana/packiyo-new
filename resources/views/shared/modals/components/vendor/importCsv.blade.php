<div class="modal fade confirm-dialog" id="import-vendors-modal" role="dialog">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content bg-white">
            <form method="post" action="{{ route('supplier.importCsv') }}" autocomplete="off" class="import-vendors-form modal-content">
                @csrf
                <div class="modal-header border-bottom mx-4 px-0">
                    <h6 class="modal-title text-black text-left" id="modal-title-notification">{{ __('Import Vendors From CSV') }}</h6>
                                                        ...
                                                        <div class="form-group mx-2 text-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    type="file"
                                                                    name="import_csv"
                                                                    id="vendors-csv-button"
                                                                    accept=".csv"
                                                                    style="display: none"
                                                                >
                                                            </div>
                                                            <button
                                                                onclick="document.getElementById('vendors-csv-button').click()"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn bg-logoOrange mx-auto px-5 text-white import-vendors">{{ __('Import') }}</button>
                </div>
            </form>
        </div>
    </div>
