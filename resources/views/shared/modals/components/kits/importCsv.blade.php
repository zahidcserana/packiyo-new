<div class="modal fade confirm-dialog" id="import-kits-modal" role="dialog">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content bg-white">
            <form method="post" action="{{ route('kits.import') }}" autocomplete="off" class="import-kits-form modal-content">
                @csrf
                <div class="modal-header border-bottom mx-4 px-0">
                    <h6 class="modal-title text-black text-left" id="modal-title-notification">{{ __('Import Kits from CSV') }}</h6>
                        ...
                        <div class="w-100">
                            <div class="form-group mb-0 mx-2 text-left mb-3">
                                <div class="">
                                            ...
                                            <tr>
                                                <td style="white-space: unset">
                                                    <div class="form-group mx-2 text-center">
                                                        ...
                                                        <button
                                                            onclick="document.getElementById('kits-csv-button').click()"
                                    ...
                                    <div id="kit-csv-filename" class="d-flex justify-content-center">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn bg-logoOrange mx-auto px-5 text-white import-kits">{{ __('Save') }}</button>
                </div>
            </form>
        </div>
    </div>
