...
<form action="" method="post" style="display: inline-block" id="deleteWarehouseForm">
    ...
    <div class="modal-footer">
        <button type="submit" class="btn bg-logoOrange mx-auto px-5 text-white deleteWarehouse">{{ __('Confirm') }}</button>
    </div>
</form>
