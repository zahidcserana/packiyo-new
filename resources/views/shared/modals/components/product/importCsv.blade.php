<div class="modal fade confirm-dialog" id="import-products-modal" role="dialog">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content bg-white">
            <form method="post" action="{{ route('product.importCsv') }}" autocomplete="off" class="import-products-form modal-content">
                @csrf
            <div class="modal-header border-bottom mx-4 px-0">
                <h6 class="modal-title text-black text-left" id="modal-title-notification">{{ __('Import Products From CSV') }}</h6>
            ...
            <div class="modal-body text-center py-3 overflow-auto">
                                                ...
                                                <div class="form-group mx-2 text-center">
                                                    ...
                                                    <div
                                                        ...
                                                        <input
                                                            ...
                                                            type="file"
                                                            name="import_csv"
                                                            id="products-csv-button"
                                                            accept=".csv"
                                                            style="display: none"
                                                        >
                                                    </div>
                                                    <button
                                                        onclick="document.getElementById('products-csv-button').click()"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn bg-logoOrange mx-auto px-5 text-white import-products">{{ __('Import') }}</button>
                </div>
            </form>
        </div>
    </div>
