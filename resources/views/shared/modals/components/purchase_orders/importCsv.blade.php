<div class="modal fade confirm-dialog" id="import-purchase-orders-modal" role="dialog">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content bg-white">
            <form method="post" action="{{ route('purchase_order.importCsv') }}" autocomplete="off" class="import-purchase-orders-form modal-content">
                @csrf
                <div class="modal-header border-bottom mx-4 px-0">
                    <h6 class="modal-title text-black text-left" id="modal-title-notification">{{ __('Import Purchase orders From CSV') }}</h6>
                                                        ...
                                                        <div class="form-group mx-2 text-center">
                                                            ...
                                                            <div
                                                                ...
                                                                <input
                                                                    ...
                                                                    type="file"
                                                                    name="import_csv"
                                                                    id="purchase-orders-csv-button"
                                                                    accept=".csv"
                                                                    style="display: none"
                                                                >
                                                            </div>
                                                            <button
                                                                onclick="document.getElementById('purchase-orders-csv-button').click()"
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn bg-logoOrange mx-auto px-5 text-white import-purchase-orders">{{ __('Import') }}</button>
                </div>
            </form>
        </div>
    </div>
