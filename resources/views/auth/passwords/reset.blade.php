...
@section('container.content')
    <div style="max-width: 600px;" class="card m-0 w-100">
        ...
        <div class="card-body">
            <form role="form" method="POST" class="loginForm m-0" action="{{ route('password.update') }}">
                @csrf
                ...
                <button type="submit" class="btn btn-dark text-white w-100 my-3">{{ __('Reset Password') }}</button>
