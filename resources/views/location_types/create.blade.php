...
@section('content')
    @component('layouts.headers.auth', [ 'title' => __('Location Types'), 'subtitle' => __('Add'), 'buttons' => [['title' => __('Back to list'), 'href' => route('location_type.index')]]])
    @endcomponent
            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive p-4">
                        <form method="post" action="{{ route('location_type.store') }}" autocomplete="off">
                            @csrf
                            <div class="d-flex orderContactInfo flex-column">
                                ...
                                <div class="ml-2 d-flex">
                                    @include('shared.forms.select', [
                                        ...
                                        'label' => __('Pickable'),
                                        'containerClass' => 'w-50',
                                        'value' => \App\Models\LocationType::PICKABLE_NOT_SET,
                                        'options' => [
                                    ...
                                    @include('shared.forms.select', [
                                        ...
                                        'value' => \App\Models\LocationType::SELLABLE_NOT_SET,
                                        'options' => [
                                ...
                                <div class="ml-2 d-flex">
                                    @include('shared.forms.select', [
                                        ...
                                        'containerClass' => 'w-50',
                                        'value' => \App\Models\LocationType::BULK_SHIP_PICKABLE_NOT_SET,
                                        'options' => [
                                    ...
                                    @include('shared.forms.select', [
                                        ...
                                        'containerClass' => 'w-50 ml-2',
                                        'value' => \App\Models\LocationType::DISABLED_ON_PICKING_APP_NOT_SET,
                                        'options' => [
