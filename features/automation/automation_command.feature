...
Feature: Automation CLI
    ...
    Scenario: Creating a basic automation for a standalone customer
        Given I will run the "automation:create" command
        And I will choose for the automation to be owned by the customer "Test Client"
        ...
        And I will choose to add the action "SetFlagAction"
        And I will choose to set the flag "allow_partial" to "on"
        And I will choose not to add an action when prompted
        And I save the automation when prompted
        And I will name the automation "Allow partial on all" when prompted
        ...
        Then the customer "Test Client" should have an order automation named "Allow partial on all"
        And the automation should be disabled
        And the automation should be triggered by the "App\Events\OrderCreatedEvent" event

    Scenario: Creating a basic automation for a 3PL targetting all clients
        Given I will run the "automation:create" command
        And I will choose for the automation to be owned by the customer "Test 3PL"
        And I will choose for the automation to apply to all 3PL clients
        And I will choose "App\Events\OrderCreatedEvent" as the only triggering event
        And I will choose not to add a condition when prompted
        And I will choose to add the action "SetFlagAction"
        And I will choose to set the flag "allow_partial" to "on"
        ...
        And the command should succeed with the message "Your automation was saved."
        When I run the command as intended
        Then the customer "Test 3PL" should have an order automation named "Allow partial on all"
        And the automation should be disabled
        And the automation should be triggered by the "App\Events\OrderCreatedEvent" event
        And the automation should apply to all 3PL clients

    Scenario: Creating a basic automation for a 3PL targetting some clients
        Given I will run the "automation:create" command
        And I will choose for the automation to be owned by the customer "Test 3PL"
        ...
        And the automation should have no conditions
        And the automation should have a "SetFlagAction" action

    Scenario: Creating a basic automation for a 3PL targetting all but some clients
        Given I will run the "automation:create" command
        And I will choose for the automation to be owned by the customer "Test 3PL"
        And I will choose for the automation to apply to all but the 3PL client "Test 3PL Client"
        And I will choose "App\Events\OrderCreatedEvent" as the only triggering event
        And I will choose not to add a condition when prompted
        And I will choose to add the action "SetFlagAction"
        And I will choose to set the flag "allow_partial" to "on"
        ...
        And the automation should be disabled
        And the automation should be triggered by the "App\Events\OrderCreatedEvent" event
        And the automation should not apply to the 3PL client "Test 3PL Client"
        And the automation should have no conditions
        And the automation should have a "SetFlagAction" action

    Scenario: Creating an automation with alternative criteria
        Given I will run the "automation:create" command
        And I will choose for the automation to be owned by the customer "Test Client"
        And I will choose "App\Events\OrderCreatedEvent" as the only triggering event
        And I will choose to add the condition "OrderIsManualCondition"
        And I will choose to check for manual orders
        And I will choose to add another "or" condition when prompted
        And I will choose to also add the condition "OrderTagsCondition"
        And I will choose to have "all" tags matched
        And I will choose to check for the tags
            | creative-name | inner-joke |
        And I will choose not to add another trigger when prompted
        And I will choose to add the action "SetFlagAction"
        And I will choose to set the flag "allow_partial" to "on"
        And I will choose not to add an action when prompted
        And I save the automation when prompted
        ...
        And the automation should be disabled
        And the automation should be triggered by the "App\Events\OrderCreatedEvent" event
        And the automation should have a "OrderIsManualCondition" condition using the "and" operator
        And the automation should have a "OrderTagsCondition" condition using the "or" operator
        And the automation should have a "SetFlagAction" action
