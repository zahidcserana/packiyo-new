...
Feature: Generate batch invoices for 3pl as standalone i get an error
    As the owner of a 3PL business
    I want to generate batch invoices for myself
    I get an error
    ...
    Scenario: 3pl is a standalone, will generate an error
        ...
        When I calculate invoice for 3pl "Test 3PL" clients for the period "2024-05-01" to "2024-05-15" I get an error with message "Customer does not wallet feature"
