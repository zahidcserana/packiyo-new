...
Feature: Billing for packages over different periods
    ...
    Scenario: Billing a package rate with flat fee for shipments within the period will generate cache document on the fly
        ...
        And I calculate an invoice for customer "Test 3PL Client" for the period "2024-04-01" to "2024-04-28"
        And the invoice is calculated in the background
        Then the invoice should have 1 invoice items
        And 1 invoice item for 1.50 has a quantity of 1.00 and the description 'Charge for box name: 6" x 6" x 6" Brown Box'
    ...
    Scenario: Billing a package rate with percentage for shipments within the period will generate cache document on the fly
        ...
        And the invoice is calculated in the background
        Then the invoice should have 1 invoice items
        And 1 invoice item for 1 has a quantity of 1.00 and the description 'Charge for box name: 6" x 6" x 6" Brown Box'
    ...
    Scenario: Billing a package rate with percentage for shipments within the period will generate cache document on the fly
        ...
        And the invoice is calculated in the background
        Then the invoice should have 1 invoice items
        And 1 invoice item for 0 has a quantity of 1.00 and the description 'Charge for box name: 6" x 6" x 6" Brown Box'
    ...
    Scenario: Billing a package rate with flat fee and applies to customer shipping boxes, for shipments within the period will generate cache document on the fly
        ...
        And the invoice is calculated in the background
        Then the invoice should have 1 invoice items
        And 1 invoice item for 1.5 has a quantity of 1.00 and the description 'Charge for box name: 6" x 6" x 6" Brown Box'
