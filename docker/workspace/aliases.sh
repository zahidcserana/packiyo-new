...
function queue() {
  php artisan queue:work --queue=$1 --tries=5 --memory=8192 --timeout=0 --sleep=1
}

alias queues="queue default,allocation-high,allocation,picking,bulkshipping,billing,data-warehouse,webhooks"
