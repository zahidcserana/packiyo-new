...
use App\Http\Middleware\DataTableMaxLength;
use App\Http\Middleware\IsAdminUserMiddleware;
use App\Http\Middleware\WidgetShortcodeMiddleware;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\SessionCustomerDataMiddleware::class,
            DataTableMaxLength::class,
        ],
    ...
    protected $routeMiddleware = [
        ...
        '3pl' => \App\Http\Middleware\Is3PLCustomerMiddleware::class,
