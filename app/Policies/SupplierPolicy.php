...
class SupplierPolicy
{
    ...
    {
        return $user->isAdmin() || $user->canAccessCustomer($supplier->customer_id);
    }
    ...
    public function update(User $user, $data = null)
    {
        ...
        if (isset($data['id']) && $supplier = Supplier::find($data['id'])) {
            if ($user->canAccessCustomer($supplier->customer_id) == false) {
                return false;
            }
        }
    ...
    public function delete(User $user, $data = null)
    {
        ...
        if (isset($data['id']) && $supplier = Supplier::find($data['id'])) {
            return $user->canAccessCustomer($supplier->customer_id);
        }
