...
class ShippingBoxPolicy
{
    ...
    {
        return $user->isAdmin() || $user->canAccessCustomer($shippingBox->customer_id);
    }
    ...
    public function update(User $user, $data = null)
    {
        ...
        if (isset($data['id']) && $shippingBox = ShippingBox::find($data['id'])) {
            if ($user->canAccessCustomer($shippingBox->customer_id) == false) {
                return false;
            }
        }
    ...
    public function delete(User $user, $data = null)
    {
        ...
        if (isset($data['id']) && $shippingBox = ShippingBox::find($data['id'])) {
            return $user->canAccessCustomer($shippingBox->customer_id);
        }
