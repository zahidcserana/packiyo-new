...
class ShipToStateConditionSchema extends AutomationConditionSchema
{
    /**
     ...
     * @var string
     */
    public static string $model = ShipToStateCondition::class;
    ...
    public function fields(): array
    {
        return array_merge(parent::fields(), [
            ID::make(),
            ArrayList::make('states', 'text_field_values')->deserializeUsing(
