...
class ShippingOptionConditionSchema extends AutomationConditionSchema
{
    /**
     ...
     * @var string
     */
    public static string $model = ShippingOptionCondition::class;
    ...
    public function fields(): array
    {
        return array_merge(parent::fields(), [
            ID::make(),
            ArrayList::make('shipping_options', 'text_field_values')->deserializeUsing(
