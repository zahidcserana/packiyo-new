...
class ExternalCarrierCredentialSchema extends Schema
{
     ...
     * @var string
     */
    public static string $model = ExternalCarrierCredential::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('reference'),
            Str::make('get_carriers_url'),
            Str::make('create_shipment_label_url'),
            Str::make('create_return_label_url'),
            Str::make('void_label_url'),
