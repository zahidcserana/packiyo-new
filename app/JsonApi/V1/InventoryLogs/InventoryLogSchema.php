...
class InventoryLogSchema extends Schema
{
     ...
     * @var string
     */
    public static string $model = InventoryLog::class;
    ...
    public function fields(): array
    {
        return [
            ID::make(),
            Str::make('source_type'),
            Str::make('destination_type'),
            Str::make('quantity'),
            HasOne::make('user'),
            HasOne::make('product'),
            MorphTo::make('source'),
            MorphTo::make('destination'),
    ...
    public function filters(): array
    {
        return [
            WhereIdIn::make($this),
            Where::make('source_type'),
            Where::make('destination_type'),
            Where::make('quantity'),
