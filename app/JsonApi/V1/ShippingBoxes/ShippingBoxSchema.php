...
class ShippingBoxSchema extends Schema
{
     ...
     * @var string
     */
    public static string $model = ShippingBox::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('height')->sortable(),
            Str::make('length')->sortable(),
            Str::make('width')->sortable(),
