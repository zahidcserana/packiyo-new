...
namespace App\JsonApi\V1\PickingCarts;
...
class PickingCartsSchema extends Schema
{
     ...
     * @var string
     */
    public static string $model = PickingCart::class;
    ...
    public function fields(): array
    {
        return [
            ...
            Str::make('number_of_totes')->sortable(),
