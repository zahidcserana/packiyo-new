...
namespace App\JsonApi\V1\ReturnStatuses;
...
class ReturnStatusSchema extends Schema
{
     ...
     * @var string
     */
    public static string $model = ReturnStatus::class;
