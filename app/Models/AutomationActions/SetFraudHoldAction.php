...
class SetFraudHoldAction extends AutomationAction implements AutomationActionInterface
{
    use SetFlagActionTrait;

    protected $attributes = [
        'field_name' => OrderFlag::FRAUD_HOLD,
    ];
    public static function getBuilderColumns(): array
    {
        return [
            'type' => SetFlagAction::class,
            'field_name' => OrderFlag::FRAUD_HOLD->value
        ];
    }

    public function getTitleAttribute(): String
    {
        return 'Set fraud hold';
    }
}
