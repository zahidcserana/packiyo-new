...
class MarkAsFulfilledAction extends AutomationAction implements AutomationActionInterface, AutomationBaseObjectInterface
{
    ...
    public function run(AutomatableEvent $event): void
    {
        ...
        if ($this->ignore_cancelled || is_null($this->cancelled_at)) {
